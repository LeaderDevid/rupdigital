...
const demoFAQs = [
  ...
  { question: 'Is it safe to buy from RupDigital?', answer: 'Yes, we are a trusted platform with thousands of satisfied customers. We provide full warranty for our products.' },
