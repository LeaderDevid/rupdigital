    ...
    <footer className="bg-gray-50 border-t border-gray-200 pt-16 pb-8 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div className="col-span-1 md:col-span-1">
          <Link to="/" className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xl font-bold text-gray-900">RupDigital</span>
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li className="flex items-start gap-3">
              ...
              <span className="text-gray-600 text-sm">{settings?.whatsappNumber || '01672822235'}</span>
            </li>
            <li className="flex items-start gap-3">
              <Mail className="w-5 h-5 text-indigo-600 shrink-0" />
              <span className="text-gray-600 text-sm">{settings?.email || 'arupsarkarapuofficial@gmail.com'}</span>
            </li>
            <li className="flex items-start gap-3">
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-gray-200 text-center">
        <p className="text-gray-500 text-sm">
          &copy; {new Date().getFullYear()} RupDigital. All rights reserved.
        </p>
      </div>
    </footer>
  );
