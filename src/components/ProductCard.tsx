...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  const handleWhatsApp = (e: React.MouseEvent) => {
    e.stopPropagation();
    e.preventDefault();
    const message = `Hello RupDigital! I am interested in ${product.title} (Price: ${formatPrice(product.salePrice)}). Can you help me?`;
    window.open(`https://wa.me/8801672822235?text=${encodeURIComponent(message)}`, '_blank');
  };
