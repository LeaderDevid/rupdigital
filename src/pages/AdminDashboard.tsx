  ...
  const seedDatabase = async () => {
    ...
    try {
      ...
      await setDoc(doc(db, 'settings', 'general'), {
        whatsappNumber: '01672822235',
        email: 'arupsarkarapuofficial@gmail.com',
        location: 'Gaibandha, Bangladesh',
        facebookPage: 'https://facebook.com/rupdigital',
        paymentNumber: '01922652210'
      });
    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500">Welcome back! Here's what's happening with RupDigital.</p>
        </div>
        <div className="flex gap-4">
          <button 
            onClick={clearDatabase}
            className="bg-red-600/10 text-red-500 px-6 py-3 rounded-2xl font-bold hover:bg-red-600 hover:text-white transition-all border border-red-500/20"
          >
            Clear All Data
          </button>
          {products.length === 0 && (
