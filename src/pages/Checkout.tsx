...
const Checkout: React.FC = () => {
  ...
  const adminNumber = settings?.paymentNumber || '01922652210';
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsapp = settings?.whatsappNumber?.replace(/\D/g, '') || '8801672822235';
    
    const message = `*New Order from RupDigital*
--------------------------
*Order ID:* ${orderId}
